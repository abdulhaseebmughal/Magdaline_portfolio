    ...
    <section id="about" className="py-24 md:py-[100px]" style={{ backgroundColor: "#FFFFFF" }}>
      <div className="container-x grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-start">
        <div className="md:col-span-7 reveal">
          <p className="label-eyebrow text-muted-foreground mb-8">About Magdaline</p>
          <h2 className="h2-display mb-8">
            A strategist first. A writer second.
          </h2>
          <p className="text-foreground/80 mb-6" style={{ fontWeight: 300 }}>
          ...
          <p className="text-foreground/70 mb-10" style={{ fontWeight: 300 }}>
          ...
          <div className="grid grid-cols-2 gap-6 max-w-md">
            <div style={{ borderTop: "1px solid hsl(var(--border))" }} className="pt-4">
